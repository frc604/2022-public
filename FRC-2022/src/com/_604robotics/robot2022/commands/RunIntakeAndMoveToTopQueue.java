...
public class RunIntakeAndMoveToTopQueue extends CommandBase {
    private BallManager ballManager;
    private Intake intake;
    private BallPath ballPath;

    /** Creates a new RunIntake. */
    public RunIntakeAndMoveToTopQueue(BallManager ballManager, Intake intake, BallPath ballPath) {
    ...
    public void execute() {
        ...
        // ballPath.updateBottomQueue();  // TODO: Do we need this?
    }
