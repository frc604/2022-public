...
public class QuixHolonomicDriveController {
  ...
  public ChassisSpeeds calculate(
      Pose2d currentPose, Rotation2d currentContinousYaw, Pose2d poseRef, double xVelocityRef, double yVelocityRef, double angularVelocityRef) {
    // Calculate feedforward velocities (field-relative).
    double xFF = xVelocityRef;
    double yFF = yVelocityRef;
    double thetaFF = angularVelocityRef;
    ...
    double thetaFeedback = m_thetaController.calculate(currentContinousYaw.getRadians(), poseRef.getRotation().getRadians());
