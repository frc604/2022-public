...
def mock_robot():
    ...
    targets_table = quixsam_table.getSubTable("targets")

    # Publish empty targets
    targets_table.getEntry("0").setNumberArray([])
    ...
    traj = load_traj(os.path.join(os.path.dirname(__file__), "./trajectories/orbit.csv"))
